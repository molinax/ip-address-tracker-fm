...
const CardAddressInfo = ({ address }: Props) => {
	...
	return (
		<section className="bg-white px-4 py-6 rounded-2xl flex flex-col text-center gap-y-4">
			...
			<article className="flex flex-col gap-y-1">
				...
				<strong className="text-lg font-semibold">UTC {timezone}</strong>
			</article>
			<article className="flex flex-col gap-y-1">
				<h4 className="font-semibold text-dark-gray uppercase tracking-wide text-xs">
					ISP
				</h4>
				<strong className="text-lg font-semibold">{isp || "None"}</strong>
			</article>
		</section>
	);
};
